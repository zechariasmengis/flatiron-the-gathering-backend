...
Card.create(name: "Chris", image: "https://ca.slack-edge.com/T02MD9XTF-U01LYNW3TMM-de7dfc536650-512", hp: 50, ability: "Enchant", description: Faker::Books::Dune.quote, ability_strength: rand(10..50), rarity: ["common", "uncommon", "rare"].sample, holographic: ["plain", "epic", "legendary"].sample)
...
Card.create(name: "James", image: "https://ca.slack-edge.com/T02MD9XTF-U01KH0VVA0K-1c04c4d54d7b-512", hp: 50, ability: "First Strike", description: Faker::Books::Dune.quote, ability_strength: rand(10..50), rarity: ["common", "uncommon", "rare"].sample, holographic: ["plain", "epic", "legendary"].sample)
...
Card.create(name: "Liz", image: "https://ca.slack-edge.com/T02MD9XTF-U01JG2AS4VC-6e5b0b535adf-512", hp: 50, ability: "Flying", description: Faker::Books::Dune.quote, ability_strength: rand(10..50), rarity: ["common", "uncommon", "rare"].sample, holographic: ["plain", "epic", "legendary"].sample)
...
Card.create(name: "Marty", image: "https://ca.slack-edge.com/T02MD9XTF-U01FG7S7D50-be53f22d53e9-512", hp: 50, ability: "Hexproof", description: Faker::Books::Dune.quote,ability_strength: rand(10..50), rarity: ["common", "uncommon", "rare"].sample, holographic: ["plain", "epic", "legendary"].sample)
